...
namespace EchoFactory.Core
{
    ...
    public sealed class TechnologyState
    {
        ...
        public TechnologyState Copy() { return (TechnologyState)MemberwiseClone(); }
    }
    ...
    public sealed class StrategicState
    {
        ...
        public bool HasTechnology(TechnologyKind kind)
        {
            for (int i=0;i<Technologies.Count;i++) if (Technologies[i].Kind == kind) return Technologies[i].Unlocked;
            return false;
        }
